...
router.get('/user/:user_id', async (req, res) => {
  try {
    ...
    res.status(500).send('Server Error: Invalid Object ID')
  }
})
...
router.delete('/experience/:exp_id', auth, async (req, res) => {
  try {
    ...
    console.log(error);
    res.status(500).send('Server Error: No profile experience');
  }
}) 
...
router.delete('/education/:edu_id', auth, async (req, res) => {
  try {
    ...
    res.status(500).send('Server Error: No profile education');
  }
})
